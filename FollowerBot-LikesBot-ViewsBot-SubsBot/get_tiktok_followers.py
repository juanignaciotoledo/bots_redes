...
username = input('What is your tiktok username?\n')
...
class tiktok:
    ...
    def go_to_website(self):
        sleep(4)
        self.browser.get('https://tolinay.com/tiktok-takipci-hilesi')
        sleep(4)
        ...
        if("Başarıyla Gönderildi" in self.browser.page_source):
            ...
            print(f"\nError! Your credits have been expired! Please change your tiktok username.")
            self.browser.save_screenshot('error.png')
