...
print('Getting subs... Please do not terminate the program.')
...
class youtube:
    ...
    def go_to_website(self):
        sleep(4)
        self.browser.get('https://tolinay.com/youtube-abone-hilesi')
        sleep(4)
        ...
        if("Başarıyla Gönderildi" in self.browser.page_source):
            ...
            print(f"\nError! Your credits have been expired! Please change your youtube url.")
            self.browser.save_screenshot('error.png')
